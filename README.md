...
> 🟩 표시는 제가 **직접 구현을 담당**한 기능입니다.

| 구분 | 기능 | 담당 |
|---|---|:---:|
| 🔍 **안전 진단** | 사진 업로드 → 객체 탐지 → 발달 단계별 위험도 판정 → 위험요소 리스트 + 조치 가이드 생성 | ![담당](https://img.shields.io/badge/✅_담당-2ea44f?style=for-the-badge) |
| 🧠 **RAG 안전 가이드** | 국가 안전 가이드라인 기반 지식베이스를 참조해 신뢰도 높은 맞춤형 조언 생성 | |
| 👶 **아이 프로필** | 아이별 성장 단계를 등록해, 같은 사물도 발달 단계에 맞게 차등 진단 | ![담당](https://img.shields.io/badge/✅_담당-2ea44f?style=for-the-badge) |
| 🛒 **안전용품 추천** | 위험요소 해결에 필요한 제품을 네이버 쇼핑 API로 검색·추천 | |
| 📂 **진단 히스토리** | 분석 리포트 저장·조회·삭제, 위험요소 해결(resolve) 체크 | |
| 👥 **커뮤니티** | 진단 결과 공유, 게시글/댓글/좋아요, 일간 베스트 | ![담당](https://img.shields.io/badge/✅_담당-2ea44f?style=for-the-badge) |
